...
**** Structure templates
 ...
 #+begin_src emacs-lisp :results silent
   (setq org-structure-template-alist
         '(("s" "#+begin_src ?\n\n#+end_src" "<src lang=\"?\">\n\n</src>")
           ("S" "#+begin_src shell  :results output :eval never-export :exports both\nexec 2>&1;date;set -e; set -u; # set -x\n\necho hello world?\n#+end_src" "<src lang=\"?\">\n\n</src>")
           ("W" "* What\n  ?\n* Why  \n\n* Who  \n\n* When  \n\n* Where  \n\n* How  \n\n")
...
;(setq org-export-babel-evaluate t) ; obsolete? <2017-08-16>
(setq org-export-babel-evaluate nil)
(setq org-export-use-babel t); new?  Not defined as of Org 9.0.9
